 ...
 */
public class CustomTokenFirebaseAuthServices2 {

    private static final String TAG = "CustomTokenFirebaseAuthServices";

    private static final CustomTokenFirebaseAuthServices2 ourInstance = new CustomTokenFirebaseAuthServices2();

    private FirebaseAuth firebaseAuthServices;

    private String customToken = null;

    private CustomTokenFirebaseAuthServices2() {
        firebaseAuthServices = FirebaseAuth.getInstance();
    }

    public static CustomTokenFirebaseAuthServices2 getInstance() { return ourInstance; }
