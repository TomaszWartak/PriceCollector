...
public class OtherStoreAdapter extends PagedListAdapter<Store, OtherStoreAdapter.StoreViewHolder> {

        private OtherStoreDiffCallback otherStoreDiffCallback = null;

        public OtherStoreAdapter(OtherStoreDiffCallback storeDiffCalback){
            super(storeDiffCalback);
            this.otherStoreDiffCallback = storeDiffCalback;
        }
