...
import com.dev4lazy.pricecollector.viewmodel.DepartmentInSectorListViewModel;
...
public class DepartmentInSectorsListFragment extends Fragment {
    ...
    private void subscribeRecycler() {
        viewModel.getDepartmentInSectorsLiveData().observe( this,  new Observer<PagedList<DepartmentInSector>>() {
            @Override
